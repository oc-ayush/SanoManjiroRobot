...
from Mikey import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Mikey.__main__ import STATS, TOKEN, USER_INFO
import Mikey.modules.sql.userinfo_sql as sql
from Mikey.modules.disable import DisableAbleCommandHandler
from Mikey.modules.sql.global_bans_sql import is_user_gbanned
from Mikey.modules.sql.afk_sql import is_afk, check_afk_status
from Mikey.modules.sql.users_sql import get_user_num_chats
from Mikey.modules.helper_funcs.chat_status import sudo_plus
from Mikey.modules.helper_funcs.extraction import extract_user
from Mikey import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/MikeyBotSupport/166 ">?</a>]'.format(
            bot.username)
