...
import Mikey.modules.sql.notes_sql as sql
from Mikey import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Mikey.__main__ import DATA_IMPORT
from Mikey.modules.helper_funcs.chat_status import user_admin
from Mikey.modules.helper_funcs.alternate import typing_action

# from Mikey.modules.rules import get_rules
import Mikey.modules.sql.rules_sql as rulessql

# from Mikey.modules.sql import warns_sql as warnssql
import Mikey.modules.sql.blacklist_sql as blacklistsql
from Mikey.modules.sql import disable_sql as disabledsql

# from Mikey.modules.sql import cust_filters_sql as filtersql
# import Mikey.modules.sql.welcome_sql as welcsql
import Mikey.modules.sql.locks_sql as locksql
from Mikey.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Mikey-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
