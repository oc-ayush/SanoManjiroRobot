...
from Mikey.modules.helper_funcs.extraction import extract_user_and_text
from Mikey.modules.helper_funcs.string_handling import extract_time
from Mikey.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text(
                "Bring an order from Tokyo Manji Gang to fight a Demon disaster."
            )
        elif user_id in TIGERS:
            message.reply_text(
                "Bring an order from Tokyo Manji Gang to fight a Tiger disaster."
            )
